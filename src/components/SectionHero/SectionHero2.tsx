...
import imageRightPng from "images/image1.png";
import imageRightPng2 from "images/image2.png";
...
const DATA: Hero2DataType[] = [
  {
    ...
    heading: "Be the best!",
    subHeading: "Try to improve your skills through the CHALLENGE! 🔥",
    btnText: "Challenge now",
    btnLink: "/challenge",
  },
];
      ...
      >
        ...
        <div className="relative container pb-0 pt-14 sm:pt-20 lg:py-44">
          ...
          <div className="mt-10 lg:mt-0 lg:absolute right-0 bottom-0 top-0 w-full max-w-2xl xl:max-w-3xl 2xl:max-w-4xl">
            <img
              className="w-full h-full object-contain object-right nc-SectionHero2Item__image"
              src={item.image}
              alt={item.heading}
            />
          </div>
